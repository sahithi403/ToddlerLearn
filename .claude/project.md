...
- Style rules, proportion specs, and character definitions → `scripts/samples/IMAGE_STYLE_PROMPT.md`
- Download, drawable save, and FlashCardsActivity update steps → `scripts/WORKFLOW.md`
